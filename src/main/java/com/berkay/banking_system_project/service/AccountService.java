...
import com.berkay.banking_system_project.currencyconversion.ICurrencyConverter;
import com.berkay.banking_system_project.models.Account;
import com.berkay.banking_system_project.repository.IAccountRepository;
...
public class AccountService {
	...
	public Account addAccount(AccountCreateRequest accountCreateRequest) {
		...
		account.setUserId(Utils.getAuthenticatedUserInfo().getId());
